    ...
    public Token lexical_scan(BufferedReader br) {
		...
		switch (peek) {
			...
			default:
				 ...
				 /* Consideriamo la seguente nuova definizione di identificatori: un
					identificatore è composto da una sequenza non vuota di lettere,
					numeri, ed il simbolo di ‘underscore’ _ che:
					- non comincia con un numero e che
					- non può essere composto solo dal simbolo _. */
				
				if (Character.isLetter(peek) || Character.valueOf(peek) == 95) { 				// 95 ASCII di _
